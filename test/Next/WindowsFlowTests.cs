...
internal static class WindowsFlowTests
{
    public static IEnumerable<TestCase> All()
    {
        ...
        yield return TestCase.Sync("overlay layout scales dense routes and keeps visible rows and timer inside composite bounds", TestSuite.Windows, OverlayLayoutJourney);
