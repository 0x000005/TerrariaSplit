        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!result.ScanSucceeded)
        {
            FileAppLogger.Instance.Info(
                ...
                $"maximumDepth={result.MaximumTunnelSurfaceDistance}, requiredGoldCoinPiles={result.RequiredCoinPileMinimum}, detail={result.Detail}, " +
        ...
        FileAppLogger.Instance.Info(
            ...
            $"requiredItems={PyramidFilterItemMatcher.FormatRequiredItems(result.RequiredItemMask)}, " +
            $"maximumDepth={result.MaximumTunnelSurfaceDistance}, requiredGoldCoinPiles={result.RequiredCoinPileMinimum}, " +
