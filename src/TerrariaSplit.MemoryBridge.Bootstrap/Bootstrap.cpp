...
namespace
{
    constexpr wchar_t PayloadFileName[] = L"TerrariaSplit.MemoryBridge.Payload.dll";
    constexpr wchar_t ManagedTypeName[] = L"TerrariaSplit.MemoryBridge.Payload.EntryPoint";
    ...
    {
        swprintf_s(buffer, length, L"Local\\TerrariaSplit.MemoryBridge.%s.%lu", kind, processId);
    }
