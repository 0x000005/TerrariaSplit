...
internal readonly record struct UiPalette(
    ...
    Color ActiveNameText,
    Color ActiveNameTextOutline,
    Color ActiveNameTextShadow,
    ...
    Color DeltaEqualText,
    Color DeltaEqualTextOutline,
    Color DeltaEqualTextShadow,
    ...
    Color TimerEqualText,
    Color TimerEqualTextOutline,
    Color TimerEqualTextShadow,
    ...
    Color SplitCompletionTimeText)
{
    public static UiPalette From(UiColorSettings settings)
    {
        return new UiPalette(
            ...
            ColorText.Parse(settings.NameText, Color.White),
            ColorText.Parse(settings.NameTextOutline, Color.FromArgb(16, 16, 16)),
            ColorText.Parse(settings.NameTextShadow, Color.Black),
            ColorText.Parse(settings.ActiveNameText, Color.FromArgb(0, 117, 236)),
            ColorText.Parse(settings.ActiveNameTextOutline, Color.FromArgb(16, 16, 16)),
            ColorText.Parse(settings.ActiveNameTextShadow, Color.Black),
            ...
            ColorText.Parse(settings.DeltaEqualText, Color.White),
            ColorText.Parse(settings.DeltaEqualTextOutline, Color.FromArgb(16, 16, 16)),
            ColorText.Parse(settings.DeltaEqualTextShadow, Color.Black),
            ...
            ColorText.Parse(settings.TimerEqualText, Color.White),
            ColorText.Parse(settings.TimerEqualTextOutline, Color.FromArgb(16, 16, 16)),
            ColorText.Parse(settings.TimerEqualTextShadow, Color.Black),
