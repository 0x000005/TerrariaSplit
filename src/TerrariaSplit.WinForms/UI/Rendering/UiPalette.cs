...
internal readonly record struct UiPalette(
    ...
    Color NameText,
    Color NameTextOutline,
    Color NameTextShadow,
    Color CompletedNameText,
    Color CompletedNameTextOutline,
    Color CompletedNameTextShadow,
    Color IconOutline,
    Color IconShadow,
    ...
    Color SplitCompletionTimeText)
{
    public static UiPalette From(UiColorSettings settings)
    {
        return new UiPalette(
            ...
            ColorText.Parse(settings.NameText, Color.FromArgb(226, 226, 226)),
            ColorText.Parse(settings.NameTextOutline, Color.FromArgb(16, 16, 16)),
            ColorText.Parse(settings.NameTextShadow, Color.Black),
            ColorText.Parse(settings.CompletedNameText, Color.FromArgb(240, 160, 64)),
            ColorText.Parse(settings.CompletedNameTextOutline, Color.FromArgb(16, 16, 16)),
            ColorText.Parse(settings.CompletedNameTextShadow, Color.Black),
