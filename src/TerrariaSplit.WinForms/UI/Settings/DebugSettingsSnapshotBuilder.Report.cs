...
internal static partial class DebugSettingsSnapshotBuilder
{
    private static string BuildReport(DebugSettingsSnapshot snapshot, Func<string, string> localize)
    {
        ...
        AppendReportSection(
            ...
            "Memory & Signatures",
            [
                ("Scan attempts", snapshot.Memory.ScanAttempts),
                ("Last scan", snapshot.Memory.LastScan),
                ("Scan page stats", snapshot.Memory.ScanPageStats),
                ("Scan failures", snapshot.Memory.ScanFailures),
                ("Main module base", snapshot.Memory.MainModuleBase),
                ("Main module size", snapshot.Memory.MainModuleSize),
                ("UpdateTime address", snapshot.Memory.UpdateTimeAddress),
                ("Boss flags address", snapshot.Memory.BossFlagsAddress),
