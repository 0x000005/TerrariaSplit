...
internal sealed class ChineseStrings : ILocalizedStringProvider
{
    private static readonly Dictionary<string, string> Values = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "Penalty", "罚时" },
        { "Journey base", "旅途基础时间" },
        { "Journey proportional", "旅途比例时间" },
        { "Classic base", "经典基础时间" },
        { "Classic proportional", "经典比例时间" },
        { "Expert base", "专家基础时间" },
        { "Expert proportional", "专家比例时间" },
        { "Master base", "大师基础时间" },
        { "Master proportional", "大师比例时间" },
        { "Apply penalty settings", "应用罚时设置" },
        { "Connection", "连接" },
        { "Not in a room", "未加入房间" },
        { "Interface", "界面" },
        { "Server", "服务器" },
        ...
        { "Leave room", "离开房间" },
        { "Are you sure you want to leave the room?", "确定要离开房间吗？" },
        { "Are you sure you want to close the room?", "确定要关闭房间吗？" },
        ...
        { "Manual split", "手动分段" },
        { "Hotkey", "快捷键" },
        { "Complete next split", "完成下一个分段" },
        { "Open in Terraria", "在 Terraria 中打开" },
        { "Player setup", "角色设置" },
        { "World settings", "世界设置" },
        { "Seed settings", "种子设置" },
        { "Filter settings", "筛选设置" },
        { "Resource settings", "资源设置" },
        { "Minimum requirements", "数量要求" },
        { "I am the host / Create room", "我是房主 / 创建房间" },
        { "I am a member / Join room", "我是成员 / 加入房间" },
        { "Room management", "房间管理" },
        { "Room code must be four digits.", "房间码必须是四位数字。" },
        { "Restart current Race", "重新开始本局" },
        { "Race room", "房间准备" },
        { "Start Race", "开始比赛" },
        { "Preparing", "准备中" },
        { "Filtering seeds", "正在筛选种子" },
        { "Generating world", "正在生成世界" },
        { "Uploading", "正在上传" },
        { "Enter the room code provided by the host.", "输入房主提供的房间码。" },
        { "Leave empty to generate a random world.", "留空时随机生成世界。" },
        { "Configure special and secret world seeds.", "设置彩蛋种子和秘密种子。" },
        { "Choose world seed", "选择世界种子" },
        { "Random seed", "随机种子" },
        { "Enter the fixed world seed.", "输入固定世界种子。" },
        { "Configure a randomly generated world.", "配置随机生成的世界。" },
        { "A fixed seed is required.", "请输入固定世界种子。" },
        { "Special and secret seeds", "彩蛋种子和秘密种子" },
        { "Enter secret seeds separated by spaces.", "输入秘密种子，多个种子使用空格分隔。" },
        { "Continue", "继续" },
        { "Enable Cheats", "启用作弊筛选" },
        { "Paste player code", "粘贴人物代码" },
        { "Clear player code", "清除人物代码" },
        { "Player code set.", "已设置人物代码。" },
        { "Player code cleared.", "已清除人物代码。" },
