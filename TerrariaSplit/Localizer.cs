...
internal static class Localizer
{
    private static readonly Dictionary<string, string> Zh = new(StringComparer.OrdinalIgnoreCase)
    {
      ...
      , { "gameMenu address 2", "gameMenu \u5730\u5740 2" }
      , { "Boss flags address", "Boss \u6807\u8BB0\u5730\u5740" }
      , { "Hardmode address", "Hardmode \u5730\u5740" }
      , { "Failure stage", "\u5931\u8D25\u9636\u6BB5" }
      , { "Compatibility hint", "\u517C\u5BB9\u6027\u63D0\u793A" }
      , { "Status", "\u72B6\u6001" }
      , { "Yes", "\u662F" }
      , { "No", "\u5426" }
      , { "Unknown", "\u672A\u77E5" }
      ...
      , { "In menu", "\u83DC\u5355\u4E2D" }
      , { "In world", "\u4E16\u754C\u5185" }
      , { "Process: PID {0} | start {1} | arch {2}", "\u8FDB\u7A0B\uFF1APID {0} | \u542F\u52A8\u65F6\u95F4 {1} | \u67B6\u6784 {2}" }
      , { "Path: {0}", "\u8DEF\u5F84\uFF1A{0}" }
      , { "Version: {0} | module base {1} | module size {2}", "\u7248\u672C\uFF1A{0} | \u6A21\u5757\u57FA\u5740 {1} | \u6A21\u5757\u5927\u5C0F {2}" }
      , { "Watcher: attached {0} | ready {1} | game state {2}", "\u76D1\u6D4B\u5668\uFF1A\u5DF2\u9644\u52A0 {0} | \u5C31\u7EEA {1} | \u6E38\u620F\u72B6\u6001 {2}" }
      , { "Signature: {0} | profile {1} | target {2}", "\u7B7E\u540D\uFF1A{0} | \u914D\u7F6E {1} | \u76EE\u6807 {2}" }
      , { "Scan: attempts {0} | last {1}", "\u626B\u63CF\uFF1A\u6B21\u6570 {0} | \u6700\u8FD1 {1}" }
      , { "Pages: {0}", "\u9875\u9762\uFF1A{0}" }
      , { "Failures: {0}", "\u5931\u8D25\uFF1A{0}" }
      , { "Pointers: UpdateTime {0} | gameMenu {1} | gameMenu2 {2} | bossFlags {3} | hardmode {4}", "\u6307\u9488\uFF1AUpdateTime {0} | gameMenu {1} | gameMenu2 {2} | bossFlags {3} | hardmode {4}" }
      , { "Hint: {0}", "\u63D0\u793A\uFF1A{0}" }
      , { "Watcher status: {0}", "\u76D1\u6D4B\u72B6\u6001\uFF1A{0}" }
      , { "Window status: {0}", "\u7A97\u53E3\u72B6\u6001\uFF1A{0}" }
