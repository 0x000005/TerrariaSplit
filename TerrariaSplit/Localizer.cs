...
internal static class Localizer
{
    private static readonly Dictionary<string, string> Zh = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "Reference time column", "参考时间" },
        { "Selected run time column", "该局时间" },
        { "Personal best time column", "个人最佳时间" },
        ...
        { "Personal segment", "成绩分段" },
        { "Personal best segment", "最佳分段" },
